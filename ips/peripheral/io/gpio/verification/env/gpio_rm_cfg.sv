...
class gpio_rm_cfg extends uvm_object;
  ...
  // UVM Automation
  // ---------------------------------------------------------------------------
  `uvm_object_utils_begin(gpio_rm_cfg)
    `uvm_field_int(enable, UVM_ALL_ON)
  `uvm_object_utils_end

  /// @brief Constructor
  /// @param name Configuration object name string
  extern function new(string name = "gpio_rm_cfg");
...
/// @param name Configuration object name string
function gpio_rm_cfg::new(string name = "gpio_rm_cfg");
  super.new(name);
endfunction
...
function void gpio_rm_cfg::pre_randomize();
  super.pre_randomize();
...
function void gpio_rm_cfg::post_randomize();
