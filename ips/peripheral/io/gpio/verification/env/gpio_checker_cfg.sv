...
class gpio_checker_cfg extends uvm_object;
  ...
  // UVM Automation
  // ---------------------------------------------------------------------------
  `uvm_object_utils_begin(gpio_checker_cfg)
  ...
  extern function new(string name = "gpio_checker_cfg");
...
/// @param name Configuration object name string
function gpio_checker_cfg::new(string name = "gpio_checker_cfg");
  super.new(name);
endfunction
...
function void gpio_checker_cfg::pre_randomize();
  super.pre_randomize();
...
function void gpio_checker_cfg::post_randomize();
