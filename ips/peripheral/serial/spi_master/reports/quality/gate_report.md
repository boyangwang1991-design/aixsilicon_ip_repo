...
schema_version: '2.0'
ip_name: spi_master
generated_by: 15-regression-quality-review/scripts/evaluate_quality.py + SPI mixed-proof
  adapter
gates:
- id: G0
  status: pass
...
- id: G4
  ...
  - id: g4.verification_assets
    ...
    detail: verification features=10; smoke testcase IDs=1; all-tier testcase IDs=10;
      implementation mappings=10; invalid mappings=0; regression list match=True;
      distinct testcase implementations=10; valid lifecycle traces=4/4; testplans=11;
      UVM testcases=9
    evidence:
    ...
    - path: scripts/check_delivery.py
      status: present
      sha256: 117836df697ebeb00fd5d83922dd446b668195c802fe9e714fe146b27d56de58
    - path: verification/tc/tc_spi_apb.sv
      status: present
      sha256: 972c2d846f440d196c5151fa848ac3e852ead6639c4a9e13de7483b2a95f711c
    - path: verification/tc/tc_spi_modes.sv
  ...
  - id: g4.full_regression_evidence
    ...
    detail: 'regression: validated REPORT_META; tests=53; failures=0; errors=0; skipped=0;
      missing/non-passing testcase IDs=0; executions=10; every testcase is bound to
      a passing raw log'
    evidence:
    - path: reports/regression/regression_summary.md
      status: present
