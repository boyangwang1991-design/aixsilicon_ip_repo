...
class pqc_checker_cfg extends uvm_object;
  ...
  extern function new(string name = "pqc_checker_cfg");
...
/// @param name Configuration object name string
function pqc_checker_cfg::new(string name = "pqc_checker_cfg");
  super.new(name);
endfunction
...
function void pqc_checker_cfg::pre_randomize();
  super.pre_randomize();
...
function void pqc_checker_cfg::post_randomize();
