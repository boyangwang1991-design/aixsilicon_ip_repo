// Synthesis-only blackbox view; simulation selects rtl/pqc_ecc_sram.sv.
// ============================================================================
...
module pqc_ecc_sram #(
  ...
  // Empty physical memory boundary. No behavioral array may be synthesized.
  // Real macro binding and read timing are platform integration obligations.
