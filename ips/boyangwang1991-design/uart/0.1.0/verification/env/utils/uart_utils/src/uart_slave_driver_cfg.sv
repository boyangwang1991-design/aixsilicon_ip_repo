...
class uart_slave_driver_cfg extends uvm_object;
  ...
  // bit [UART_DATA_WIDTH-1:0] default_rdata = '0;
  // uart_resp_e default_resp = UART_RESP_OKAY;

  // =============================================================================
  // UVM Automation
  // =============================================================================
  // Purpose: Enable UVM field automation for print, copy, compare operations
  `uvm_object_utils_begin(uart_slave_driver_cfg)
    ...
    // `uvm_field_enum(uart_resp_e, default_resp, UVM_ALL_ON)
  `uvm_object_utils_end

  /// @brief Constructor
  /// @param name Configuration object name string
  extern function new(string name = "uart_slave_driver_cfg");
...
/// @param name Configuration object name string
function uart_slave_driver_cfg::new(string name = "uart_slave_driver_cfg");
  super.new(name);
endfunction
...
function void uart_slave_driver_cfg::pre_randomize();
  super.pre_randomize();
...
function void uart_slave_driver_cfg::post_randomize();
