// =============================================================================
// File Name   : uart_interface_agent_cfg.sv
...
`ifndef UART_INTERFACE_AGENT_CFG__SV
`define UART_INTERFACE_AGENT_CFG__SV

/// @class uart_interface_agent_cfg
/// @brief Configuration class for XX interface agent
///        Aggregates all sub-component configurations (driver, slave driver, monitor)
class uart_interface_agent_cfg extends uvm_object;
  ...
  rand uart_driver_cfg       mst_drv_cfg;  // Master driver configuration (randomizable)
  rand uart_slave_driver_cfg slv_drv_cfg;  // Slave driver configuration (randomizable)
  rand uart_monitor_cfg      mon_cfg;      // Monitor configuration (randomizable)
  ...
  `uvm_object_utils_begin(uart_interface_agent_cfg)
  ...
  extern function new(string name = "uart_interface_agent_cfg");
...
/// @param name Configuration object name string
function uart_interface_agent_cfg::new(string name = "uart_interface_agent_cfg");
  super.new(name);

  this.mst_drv_cfg = uart_driver_cfg::type_id::create("mst_drv_cfg");
  this.slv_drv_cfg = uart_slave_driver_cfg::type_id::create("slv_drv_cfg");
  this.mon_cfg     = uart_monitor_cfg::type_id::create("mon_cfg");
endfunction
...
function void uart_interface_agent_cfg::pre_randomize();
  super.pre_randomize();
...
function void uart_interface_agent_cfg::post_randomize();
