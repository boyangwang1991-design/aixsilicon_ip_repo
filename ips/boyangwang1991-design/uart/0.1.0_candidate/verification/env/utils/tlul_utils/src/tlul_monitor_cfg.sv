...
class tlul_monitor_cfg extends uvm_object;
  ...
  `uvm_object_utils_begin(tlul_monitor_cfg)
  ...
  extern function new(string name = "tlul_monitor_cfg");
...
/// @param name Configuration object name string
function tlul_monitor_cfg::new(string name = "tlul_monitor_cfg");
  super.new(name);
endfunction
...
function void tlul_monitor_cfg::pre_randomize();
  super.pre_randomize();
...
function void tlul_monitor_cfg::post_randomize();
