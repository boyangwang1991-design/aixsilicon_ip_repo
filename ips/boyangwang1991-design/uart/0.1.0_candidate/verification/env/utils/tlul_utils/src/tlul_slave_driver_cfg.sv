...
class tlul_slave_driver_cfg extends uvm_object;
  ...
  // bit [TLUL_DATA_WIDTH-1:0] default_rdata = '0;
  // tlul_resp_e default_resp = TLUL_RESP_OKAY;

  // =============================================================================
  // UVM Automation
  // =============================================================================
  // Purpose: Enable UVM field automation for print, copy, compare operations
  `uvm_object_utils_begin(tlul_slave_driver_cfg)
    ...
    // `uvm_field_enum(tlul_resp_e, default_resp, UVM_ALL_ON)
  `uvm_object_utils_end

  /// @brief Constructor
  /// @param name Configuration object name string
  extern function new(string name = "tlul_slave_driver_cfg");
...
/// @param name Configuration object name string
function tlul_slave_driver_cfg::new(string name = "tlul_slave_driver_cfg");
  super.new(name);
endfunction
...
function void tlul_slave_driver_cfg::pre_randomize();
  super.pre_randomize();
...
function void tlul_slave_driver_cfg::post_randomize();
