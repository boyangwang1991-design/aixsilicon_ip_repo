...
class uart_driver_cfg extends uvm_object;
  ...
  `uvm_object_utils_begin(uart_driver_cfg)
  ...
  extern function new(string name = "uart_driver_cfg");
...
/// @param name Configuration object name string
function uart_driver_cfg::new(string name = "uart_driver_cfg");
  super.new(name);
endfunction
...
function void uart_driver_cfg::pre_randomize();
  super.pre_randomize();
...
function void uart_driver_cfg::post_randomize();
