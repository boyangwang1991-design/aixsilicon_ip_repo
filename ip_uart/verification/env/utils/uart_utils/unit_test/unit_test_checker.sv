...
class unit_test_checker extends uvm_component;
    ...
    uvm_analysis_imp #(uart_xaction, unit_test_checker) item_export;
    ...
    extern virtual function void write(uart_xaction tr);
    
    //==========================================================================
    // 事务检查
    //==========================================================================
    
    extern virtual function void check_transaction(uart_xaction tr);
...
/// @brief 写入函数定义
/// @param tr 接收到的事务
function void unit_test_checker::write(uart_xaction tr);
    item_count++;
...
/// @brief 事务检查定义
/// @param tr 要检查的事务
function void unit_test_checker::check_transaction(uart_xaction tr);
    // 检查响应类型
    if (tr.resp == UART_RESP_ERROR) begin
